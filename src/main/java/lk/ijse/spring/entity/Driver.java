...
public class Driver {
    ...
    @OneToMany(mappedBy = "driver", cascade = CascadeType.ALL)
    private List<DriverShedule> driverShedules = new ArrayList<>();

    public Driver() {
    }

    public Driver(String driverId, String firstName, String lastName, String nic, String email, Integer contact, String address, String licensePic1, String licensePic2, boolean avalibleStatus, String username, String password, Timestamp registerDate) {
    ...
    public List<DriverShedule> getDriverShedules() {
        return driverShedules;
    }

    public void setDriverShedules(List<DriverShedule> driverShedules) {
        this.driverShedules = driverShedules;
    }
}
